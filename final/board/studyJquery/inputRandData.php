<?php
     ...
     * 게시물 입력폼이 있는 페이지로 여러 개의 게시물을 직접 입력하려면 불편하므로 프로그래밍을 통해 임의로 jquery 테이블에
     * 데이터를 입력하겠습니다.
     *
     * 다음은 jquery 테이블에 임의로 데이터를 입력하는 예제입니다.
     * */
    ...
    for ($i=1; $i<165; $i++) {
        ...
        if ($result) {
            echo "{$i}번째 jquery데이터 입력완료";
        } else {
            echo "{$i}번째 jquery데이터 입력실패";
        }
    }
?>
