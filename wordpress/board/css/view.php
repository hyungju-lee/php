<?php
     ...
     * URL에 GET 방식으로 함께 전달된 cssID 의 값을 이용하여 해당 게시물의 내용을 불러오는 방식으로 구현합니다.
     *
...
<div id="wrap">
    ...
    <div id="container">
        <div id="contents">
            ...
            if (isset($_GET['cssID']) && (int) $_GET['cssID'] > 0) {
                $cssID = $_GET['cssID'];
                $sql = "SELECT b.memberID, b.title, b.content, m.nickname, b.regTime FROM css b ";
                $sql .= "JOIN member m ON (b.memberID = m.memberID) ";
                $sql .= "WHERE b.cssID = {$cssID}";
