<?php
    /*
     * 앞에서 생성한 게시글 입력폼 페이지에서 입력한 정보를 javascript 테이블에 저장하는 기능을 생성하겠습니다.
     ...
     *
     * 다음은 게시글을 javascript 테이블에 저장하는 예제입니다.
     * */

    date_default_timezone_set('Asia/Seoul');

    // javascript 테이블의 memberID 필드에는 $_SESSION['memberID'] 의 값을 입력하므로
    // session_start() 함수가 있는 파일을 include 합니다.
    include '../../common/session.php';
    // 로그인을 하지 않고 181-savejavascript.php 에 접근하는 것을 방지하도록 179-checkSignSession.php 파일을 include 합니다.
    include '../../common/checkSignSession.php';
    // javascript 테이블에 데이터를 입력하므로 데이터베이스 접속 프로그램인 163-connection.php 파일을 include 합니다.
    ...
    // javascript 테이블의 memberID 필드에 입력할 값이 세션 $_SESSION['memberID'] 를 변수 memberID 에 대입합니다.
    $memberID = $_SESSION['memberID'];

    // 해당 게시물의 입력 시간을 변수 regTime 에 대입합니다.
    $regTime = time();

    // 게시물을 javascript 테이블에 입력하는 쿼리문입니다.
    $sql = "INSERT INTO javascript (memberID, title, content, regTime) ";
