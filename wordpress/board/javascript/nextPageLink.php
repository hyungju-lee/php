<?php
    ...
    // 전체 레코드 수 구하기
    // javascript 테이블의 레코드 수를 불러오는 쿼리문입니다.
    $sql = "SELECT count(javascriptID) FROM javascript";
    // 쿼리문을 실행합니다.
    ...
    // 쿼리문의 데이터를 변수 javascriptTotalCount 에 대입합니다.
    $javascriptTotalCount = $result->fetch_array(MYSQLI_ASSOC);
    // 변수 javascriptTotalCount 의 레코드 수 정보를 변수 javascriptTotalCount 에 다시 대입합니다.
    $javascriptTotalCount = $javascriptTotalCount['count(javascriptID)'];
    ...
    $totalPage = ceil($javascriptTotalCount / $numView);
