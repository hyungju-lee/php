<?php
     ...
     * URL에 GET 방식으로 함께 전달된 htmlID 의 값을 이용하여 해당 게시물의 내용을 불러오는 방식으로 구현합니다.
     *
...
<div id="wrap">
    ...
    <div id="container">
        <div id="contents">
            ...
            if (isset($_GET['htmlID']) && (int) $_GET['htmlID'] > 0) {
                $htmlID = $_GET['htmlID'];
                $sql = "SELECT b.memberID, b.title, b.content, m.nickname, b.regTime FROM html b ";
                $sql .= "JOIN member m ON (b.memberID = m.memberID) ";
                $sql .= "WHERE b.htmlID = {$htmlID}";
                ...
                if ($result) {
                    ...
                    echo "<a href='/wordpress/html/list.php'>목록으로 이동</a>";
                } else {
                    echo "잘못된 접근입니다.";
                    exit;
                }
